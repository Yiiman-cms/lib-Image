<?php
	/**
	 * @author http://image.intervention.io/getting_started
	 */
...
class ImageManager
{
    ...
    {
        if (class_exists('system\\lib\\imageManager\\ImageCache')) {
            // create imagecache
        ...
        throw new \system\lib\imageManager\Exception\MissingDependencyException(
