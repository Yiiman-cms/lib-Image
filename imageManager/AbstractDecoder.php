...
abstract class AbstractDecoder
{
    ...
    public function initFromUrl($url)
    {
        ...
        throw new \system\lib\imageManager\Exception\NotReadableException(
    ...
    /**
     * Determines if current source data is system\lib\imageManager\Image object
     *
     * @return boolean
     */
    public function isInterventionImage()
    {
        return is_a($this->data, '\system\lib\imageManager\Image');
    }
    ...
    /**
     * Initiates new Image from system\lib\imageManager\Image
     *
     * @param  Image $object
     * @return \system\lib\imageManager\Image
     */
