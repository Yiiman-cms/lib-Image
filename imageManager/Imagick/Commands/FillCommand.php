...
use system\lib\imageManager\Image;
use system\lib\imageManager\Imagick\Decoder;
use system\lib\imageManager\Imagick\Color;

class FillCommand extends \system\lib\imageManager\Commands\AbstractCommand
{
    /**
    ...
    public function execute($image)
    {
        ...
        } catch (\system\lib\imageManager\Exception\NotReadableException $e) {
