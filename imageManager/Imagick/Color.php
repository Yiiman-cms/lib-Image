...
class Color extends \system\lib\imageManager\AbstractColor
{
    /**
     ...
     *
     * @param  int $value
     * @return \system\lib\imageManager\AbstractColor
     */
     ...
     * @return boolean
     */
    public function differs(\system\lib\imageManager\AbstractColor $color, $tolerance = 0)
    {
